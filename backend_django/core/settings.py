"""
Django settings for SIR (backend_django).

- Lee variables desde:
  - backend_django/.env
  - backend_django/.env.calendar (opcional)
- Soporta SQLite/Postgres/MySQL por DB_ENGINE
- CORS/CSRF listo para Next.js (localhost:3000)
- WhiteNoise opcional (útil en deploy, no estorba en dev)
"""
...
# Cargar variables desde .env (si no existe, no truena)
